...
option=tk.StringVar()
name_display = tk.Label(top, text = "Enter  \n1 - Mark attandance\n2 - View attendance").place(x = 30,y = 50)  
enteryno1 = tk.Entry(top,textvariable=option).place(x = 95, y = 130)  
hi=partial(hi,option)
sbmitbtn = tk.Button(top, text = "Submit",activebackground = "pink", activeforeground = "blue",command=hi).place(x = 30, y = 170) 
top.mainloop()  
print(option)
